...
export function planToWordHtml(plan, logoDataUrl = "") {
  ...
  const activities = (p.activities || [])
    .map((item) => `<div class="activity-item">
      <p><b>ขั้น:</b> ${esc(item.phase)} &nbsp; <b>เวลา:</b> ${esc(item.time)}</p>
  ...
  const evaluation = (p.evaluation || [])
    .map((item) => `<div class="evaluation-item">
      ...
      <p><b>วิธีการวัด:</b> ${esc(item.method)} &nbsp; <b>เครื่องมือ:</b> ${esc(item.tool)}</p>
...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .masthead { min-height: 58pt; margin-bottom: 2pt; overflow: hidden; }
  .masthead .seal { float: left; width: 62pt; text-align: center; }
  .masthead-copy { margin: 0 62pt; padding-top: 8pt; text-align: center; }
  ...
  .plan-header-meta { margin: 2pt 0 5pt; padding-bottom: 2pt; border-bottom: 0.75pt solid #777; font-size: 13.5pt; }
  ...
  .activity-item, .evaluation-item { border-left: 1.5pt solid #777; padding: 1pt 4pt; margin: 2pt 0; page-break-inside: avoid; }
  .activity-item p, .evaluation-item p { margin: 0.5pt 0; }
  .signature { margin-top: 22pt; page-break-inside: avoid; text-align: center; }
  .signature-person { display: inline-block; width: 48%; vertical-align: top; text-align: center; font-size: 15pt; }
  ...
  .post-meta { border: 0.75pt solid #555; margin-bottom: 4pt; padding: 2pt 5pt; font-size: 13.5pt; }
...
<div class="Section1">
  ...
  <div class="plan-header-meta">
    <p><b>หน่วยการเรียนรู้</b> ${esc(p.unit || "-")} &emsp; <b>เรื่อง</b> ${esc(p.topic || "-")}</p>
    <p><b>กลุ่มสาระการเรียนรู้</b> ${esc(p.subject || "-")} &emsp; <b>ชั้น</b> ${esc(p.grade || "-")}</p>
    <p><b>เวลา</b> ${esc(p.timeText || "-")} &emsp; <b>ผู้สอน</b> ${esc(p.teacher || "-")}</p>
  ...
  <div class="post-page">
    ...
    <div class="post-meta">
      <p><b>ครูผู้สอน</b> ${esc(p.teacher || "-")} &emsp; <b>รายวิชา</b> ${esc(p.subject || "-")}</p>
      <p><b>ชั้น</b> ${esc(p.grade || "-")} &emsp; <b>วันที่สอน</b> ${esc(formatThaiDate(p.teachingDate))}</p>
